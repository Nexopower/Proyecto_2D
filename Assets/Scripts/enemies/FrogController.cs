...
public class FrogController : MonoBehaviour
{
    ...
    public float jumpForceHorizontal = 4.31f;
    public float jumpForceVertical = 5.97f;
    public float jumpInterval = .99f;
    public float chaseJumpForceHorizontal = 5.81f;
    public float chaseJumpForceVertical = 7.5f;
    public float chaseJumpInterval = 0.54f;
    public float detectionRange = 4.36f;
    public float wallCheckDistance = 0.35f;
    public float groundCheckDistance = 0.04f;
    public float groundCheckWidth = 0.14f;
    public float offsetRayoX = 0f;
    public float offsetRayoY = .26444f;
