...
public class SpiderController : MonoBehaviour
{
    ...
    public float jumpForce = 5.51f;
    public float detectionRange = 3f;
    public float jumpCooldown = 2.28f; // Tiempo que tarda para volver a saltar
    public float wallCheckDistance = 0.39f;
    public float edgeCheckDistance = 0.5f;
    public float groundCheckDistance = 0.26f; // Distancia del raycast para detectar suelo
